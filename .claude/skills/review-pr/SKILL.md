...
- [ ] Hot-path benchmarks with nontrivial `Drop` or filesystem cleanup keep teardown, checkpointing, and tempdir deletion outside the timed region, especially when comparing durability modes.
