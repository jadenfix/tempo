...
- [ ] Crawl/network execution paths consume checked dispatch capabilities and connect to the policy-checked socket; raw scheduler dispatch must not be handed to a client that can re-resolve the URL.
